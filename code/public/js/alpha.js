$(document).ready(function () {
    ...
    if (1 === $(".material-design-hamburger__icon").length && document.querySelector(".material-design-hamburger__icon").addEventListener("click", function () {
        ...
        $(window).width() < 993 && !$(".mn-content").hasClass("fixed-sidebar-on-hidden") && ($(".fixed-sidebar .navigation-toggle a").click(),
            ...
            $(".search-results").hide(),
            !$("body").hasClass("quick-results-off")) {
        $(document).mouseup(function (e) {
            ...
            $(document).keyup(function (e) {
                27 == e.keyCode && ($(".search-results").fadeOut(300),
        ...
        $(".search-result-container").fadeOut(1),
            ...
            $(".search input#search").on("input", function () {
                $(".search-result-container").fadeOut(1),
                    $(".res-not-found").fadeOut(1),
                    t(function () {
                        0 != !$.trim($(".search input#search").val()).length ? ($(".search-result-container").fadeOut(1),
                            $(".res-not-found").fadeIn(1)) : $(".search-result-container").fadeIn()
                    }, 500),
        ...
        $(".left-sidebar-hover").mouseover(function () {
            $(".button-collapse").click(),
                ...
                $("#slide-out").mouseleave(function () {
                    $(this).hasClass("openOnHover") && ($(".button-collapse").click(),
