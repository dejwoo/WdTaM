/**
 * Materialbox modification to support Thumbnails
 *
 * https://github.com/Dogfalo/materialize/pull/2798/commits/286f518cbdba7b8a823c5a0059a053fee775b8d8
 */
        ...
        return this.each(function() {
            ...
            origin.on('click', function(){
                if (!imageChanged && origin.data('original') !== ""){
                    progressWrapper.insertAfter(origin);
            ...
            function onImageClick(){
                ...
                while (ancestor !== null && !$(ancestor).is(document)) {
                    var curr = $(ancestor);
                    if (curr.css('overflow') === 'hidden' || curr.css('overflow') === 'auto') {
                ...
                // Set css on origin
                origin.css({position: 'absolute', 'z-index': 1001})
